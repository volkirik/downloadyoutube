...
function show_ytp_popup(){
	...
	if ($("#listitems2018").length>0){
		...
		$("div.ytp-settings-menu").before('<div id="download_popup" class="ytp-popup ytp-contextmenu" data-visual-id="1990" style="width: 190px; height: '+set_height+'px; right: 12px; bottom: 49px; top: auto; left: auto;">'
